...
- Points encore à trancher avant d'écrire le script : méthode de merge à standardiser (squash seul ?), faut-il un `CODE_OF_CONDUCT.md` systématique, faut-il pinner les actions par SHA partout ou seulement sur les workflows avec secrets.
